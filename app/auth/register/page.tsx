    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-sm">Join us today to get started</p>
        </div>
        ...
        <form onSubmit={formik.handleSubmit} className="grid gap-4">
          ...
          <Checkbox
            ...
            errorMessage={
              formik.touched.acceptTerms ? formik.errors.acceptTerms : undefined
            }
            label={
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 px-4 rounded-full hover:from-blue-600 hover:to-purple-700 disabled:opacity-50 transition-all mt-2"
          >
        ...
        <div className="grid gap-3 mb-6">
          <button
            type="button"
            className="w-full border-2 border-gray-700 text-gray-700 font-semibold py-3 px-4 rounded-full hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
          >
        ...
        <div className="text-center">
          <span className="text-gray-700 text-sm">
            ...
            <a href="/auth/login" className="font-semibold text-blue-500 hover:text-blue-600">
              Sign in
            </a>
          </span>
        </div>
